...
wget https://download-installer.cdn.mozilla.net/pub/firefox/releases/54.0.1/linux-i686/en-US/firefox-54.0.1.tar.bz2
wget http://wyc.buzz/eb/vncxstartup.txt https://raw.githubusercontent.com/wangzhe12588/eb/master/vncserverinit.txt
